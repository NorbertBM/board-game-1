...
export default function ExplorerDeck() {
  ...
  const explorer = [
    ...
    >
      <p className="description">
        You came across a cave. Explore the cave and see what you can find. You
        might find some treasure or you might find some enemies.
      </p>
    </ExplorationCard>,
    <ExplorationCard
      card_name={"Cave"}
    ...
    >
      <p className="description">
        You came across a house. Explore the house and see what you can find.
        You might find some treasure or you might find some enemies.
      </p>
    </ExplorationCard>,
    <ExplorationCard
      card_name={"Temple"}
    ...
    >
      <p className="description">
        You came across a temple. Explore the temple and see what you can find.
        You might find some treasure or you might find some enemies.
      </p>
    </ExplorationCard>,
    <ExplorationCard
    ...
    >
      <p className="description">
        You came across the Cathedral of Nox. Here is where he meditated in
    ...
    >
      <p className="description">
        You came across Amal refugee caves. Here is where where Amal rescued
        them from the firestorm.
      </p>
    </ExplorationCard>,
    <ExplorationCard
    ...
    >
      <p className="description">
        You came across the Court of Fools. A court where no justice will be
        served only judgmend.
      </p>
    </ExplorationCard>,
    <ExplorationCard
      card_name={"Tar Pits"}
    ...
    >
      <p className="description">
        Created by the The Hatebreed, the tar pits are marshlands as far as the
        eyes can see.
      </p>
    </ExplorationCard>,
    <ExplorationCard
    ...
    >
      <p className="description">
        A unwelcoming place where The G’Nesh, who were living trees, took roots
    ...
    >
      <p className="description">
        Home of the Noari, the Pale Citadel is a place of peace and hospitality.
      </p>
    </ExplorationCard>,
    <ExplorationCard
  ...
  const getRandomCard = () => {
    ...
    const randomCard = explorer[Math.floor(Math.random() * explorer.length)];
    setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      <div className="random-card">
        <button onClick={getRandomCard}>Select Random Card</button>
